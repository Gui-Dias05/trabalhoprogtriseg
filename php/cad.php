...
<body style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">
    ...
    <content>
    <form action="<?php if(isset($_GET['id'])) { echo "cad.php?id=$id&acao=editar";} else {echo "cad.php?acao=insert";}?>" method="post" id="form" >
        ...
        <div class="col-auto">
            <div class="input-group">    
                ...
                <input class="btn btn-dark" required type="text" name="lado" id="lado" value="<?php if (isset($id)) echo $lista[0]['lado'];?>" >
            </div>
        </div><br>
        <div class="col-auto">
            <div class="input-group">    
        ...
        <div class="col-auto">
            <div class="input-group">    
                ...
                <select class="btn btn-dark" name="idtabuleiro" id="idtabuleiro" value="" class="form-select-sm border border-dark rounded-end" aria-label="Floating label select example">
                <?php
    ...
    <form method="post" style="padding-left: 0.7px;">
        ...
        <div class="form-check">
            <input class="form-check-input mt-0" style="background-color: #2e2e2e;"  type="radio" name="buscar" value="1" <?php if ($buscar == "1") echo "checked" ?> class="btn btn-dark">
            <label class="form-check-label" for="flexRadioDefault1">ID</label><br>
            <input class="form-check-input mt-0" style="background-color: #2e2e2e;" type="radio" name="buscar" value="2" <?php if ($buscar == "2") echo "checked" ?> class="btn btn-dark">
            <label class="form-check-label" for="flexRadioDefault1">Lado</label><br>
            <input class="form-check-input mt-0" style="background-color: #2e2e2e;" type="radio" name="buscar" value="3" <?php if ($buscar == "3") echo "checked" ?> class="btn btn-dark">
            <label class="form-check-label" for="flexRadioDefault1">Cor</label><br>
            <input class="form-check-input mt-0" style="background-color: #2e2e2e;" type="radio" name="buscar" value="4" <?php if ($buscar == "4") echo "checked" ?> class="btn btn-dark">
            ...
            <table border='1' class="table table-dark table-striped">
                ...
                ?>
                    <tr>
                        ...
                        <td scope="row"><a href="../mostrar/mostrar.php?id=<?php echo $linha['id']; ?>&lado=<?php echo $linha['lado'];?>&cor=<?php echo str_replace('#', '%23', $linha['cor']);?>&idtabuleiro=<?php echo $linha['tabuleiro_idtabuleiro'];?>"><img src="../img/ver.png" style="width:30px;"></a></td>
                        <td scope="row"><a href="cad.php?id=<?php echo $linha['id'];?>&idtabuleiro=<?php echo $linha['tabuleiro_idtabuleiro'];?>"><img src="../img/editar.png" style="width:30px;"></a></td>
                        <td><a onclick="return confirm('Deseja mesmo excluir?')" href="cad.php?id=<?php echo $linha['id'];?>&acao=excluir"><img src="../img/excluir.png" style="width:30px;"></a></td>
                    </tr>
                <?php } ?> 
                </tbody>
            </table>
